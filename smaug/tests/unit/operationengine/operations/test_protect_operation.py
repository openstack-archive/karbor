...
class ProtectOperationTestCase(base.TestCase):
    ...
    def setUp(self):
        ...
        self._fake_smaug_client = FakeSmaugClient()
    ...
    @mock.patch('smaug.services.operationengine.smaug_client.client')
    def test_execute(self, client):
        client.return_value = self._fake_smaug_client
        now = datetime.utcnow()
        param = {
