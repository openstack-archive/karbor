...
class TestScheduledOperationState(test_objects.BaseObjectsTestCase):
    ...
    @mock.patch('smaug.db.scheduled_operation_state_get')
    ...
    @mock.patch('smaug.db.scheduled_operation_state_update')
    ...
    @mock.patch('smaug.db.scheduled_operation_state_delete')
