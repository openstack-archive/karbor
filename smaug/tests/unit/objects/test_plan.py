...
class TestPlan(test_objects.BaseObjectsTestCase):
    ...
    @mock.patch('smaug.db.sqlalchemy.api.plan_create')
    ...
    @mock.patch('smaug.db.sqlalchemy.api.plan_update')
    ...
    @mock.patch('smaug.db.sqlalchemy.api.plan_resources_update',
                return_value=[
                    {'resource_id': 'key1',
    ...
    @mock.patch('smaug.db.sqlalchemy.api.plan_destroy')
