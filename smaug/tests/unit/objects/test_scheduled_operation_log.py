...
class TestScheduledOperationLog(test_objects.BaseObjectsTestCase):
    ...
    @mock.patch('smaug.db.scheduled_operation_log_get')
    ...
    @mock.patch('smaug.db.scheduled_operation_log_create')
    ...
    @mock.patch('smaug.db.scheduled_operation_log_update')
    ...
    @mock.patch('smaug.db.scheduled_operation_log_delete')
