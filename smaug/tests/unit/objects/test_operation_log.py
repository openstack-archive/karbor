...
from smaug.tests.unit import fake_operation_log
...
class TestOperationLog(test_objects.BaseObjectsTestCase):
    ...
    @mock.patch('smaug.objects.OperationLog.get_by_id')
    ...
    @mock.patch('smaug.db.sqlalchemy.api.operation_log_create')
    ...
    @mock.patch('smaug.db.sqlalchemy.api.operation_log_update')
    ...
    @mock.patch('smaug.db.sqlalchemy.api.operation_log_destroy')
